...
import {
  Char, CharCode, Recipe, RecipeCode,
} from './types';
 ...
 * @param recipes
 */
export function assembleCodes(recipes: RecipeCode[]): CharCode[] {
 ...
 * @param recipes
 */
export function assemble(recipes: Recipe[]): string {
 ...
 * @param codes
 */
export function disassembleCodes(codes: CharCode[]): RecipeCode[] {
  return codes.map((code): RecipeCode => {
 ...
 * @param text
 */
export function disassemble(text: string): Recipe[] {
  return text.split('').map((char): Recipe => {
...
export function flatAssembleCodes(codes: CharCode[]): CharCode[] {
  ...
  return assembleCodes(recipes as RecipeCode[]);
}
